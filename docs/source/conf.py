...
# -*- coding: utf-8 -*-
#
# OH Auto Statistical documentation build configuration file, created by
# sphinx-quickstart on Tue Dec  9 20:36:57 2014.
#
...
htmlhelp_basename = 'OHAutoStatisticaldoc'
...
latex_documents = [
  ('index', 'OHAutoStatistical.tex', 'OH Auto Statistical Documentation',
   'Florenz A. P. Hollebrandse', 'manual'),
]
...
man_pages = [
    ('index', 'ohautostatistical', 'OH Auto Statistical Documentation',
     ['Florenz A. P. Hollebrandse'], 1)
]
...
texinfo_documents = [
  ('index', 'OHAutoStatistical', 'OH Auto Statistical Documentation',
   'Florenz A. P. Hollebrandse', 'OHAutoStatistical', 'One line description of project.',
   'Miscellaneous'),
]
